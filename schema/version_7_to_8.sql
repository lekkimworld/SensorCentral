create table USER_HOUSE_ACCESS (userId character varying(36) not null, houseId character varying(36) not null, is_default boolean default false not null, owner boolean default false not null);
