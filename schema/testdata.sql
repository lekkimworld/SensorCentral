...
insert into sensor (id,name,label,type,icon,deviceid) values ('94f7a0f4-d85b-4815-9c77-833be7c28779', 'My Smartme 4-1', 'mysmartme_4-1', 'gauge', 'battery-4', 'mydevice_3');
