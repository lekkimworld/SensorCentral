...
insert into DATABASE_VERSION (version) values (4);
...
create table DEVICE (id character varying(36) not null primary key, name character varying(128) not null, houseid character varying(36) not null, last_ping timestamp with time zone, last_restart timestamp with time zone, last_watchdog_reset timestamp with time zone);
