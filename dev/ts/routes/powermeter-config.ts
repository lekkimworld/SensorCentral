...
export default (elemRoot: JQuery<HTMLElement>) => {
    const updateUI = () => {
        ...
        graphql(`{houses{id,name}}`).then(data => {
            ...
            elemRoot.append(`<p>Use this page to configure the connection between SensorCentral 
                ...
                <div class="sensorcentral-section">
                    ...
                    <div class="p-2">
                        ...
                        ${dropdown({
                            name: "house",
                            label: "House",
                            fieldExplanation: "Select the house the powermeter belongs to.",
                            dropdownOptions: houseOptions,
                            required: true,
                            addBlank: true
                        })}
                    </div>
                    ...
                    <div class="p-2">
                        ...
                        <form class="mt-3">
                            ${textField({
                                ...
                                label: "Powermeter ID",
                                fieldExplanation: "Specify the ID of the powermeter to create sensor for. Only required if you have more than one powermeter on your smart.me account."
                            })}
                            ${toggleButton({
                                name: "createIfMissing",
                                label: "Create",
                                fieldExplanation: "Enable to create a sensor (and device) for the powermeter sensor not found."
                            })}
                            <p class="text-center">
                                ${buttonPerformAction("Check (and create)", "check")}
                            </p>
                        </form>
                ...
                <div class="sensorcentral-section mt-3">
                    ...
                    <div class="p-2">
                        ${dropdown({
                            name: "frequency",
                            label: "Frequency",
                            fieldExplanation: "Select the frequency in minutes to request powermeter data",
                            dropdownOptions: {
                                1: "Every 1 minute",
                                2: "Every 2 minutes",
                                5: "Every 5 minutes",
                        ...
                        <p class="text-center">
                            ${buttonPerformAction("Create realtime subscription!", "create-subscription")}
                        </p>
                ...
                <div class="sensorcentral-section mt-3">
                    ...
                    <div class="p-2">
                        <p class="text-center">
                            ${buttonPerformAction("Remove realtime subscription!", "remove-subscription")}
                        </p>
        ...
        if (rel === "verify") {
            ...
            errorClear(resultsId)
                .then(() => {
                    ...
                    // look for sensor
                    return graphql(`{sensor(id:"${specifiedId}"){id, type, name}}`)
                        .then((sensor) => {
                            // found sensor
