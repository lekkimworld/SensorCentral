    ...
    const powerpriceChart1 = addChartContainer(elem, {
        ...
        data: async (containerData) => {
            ...
            periods.push({
                ...
                prices: [
                    0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.46, 0.46, 0.46, 0.46, 0.46, 0.46, 0.46, 0.46, 0.46, 0.46,
                    0.46, 1.37, 1.37, 1.37, 1.37, 0.46, 0.46, 0.46,
                ],
            } as EnergyPeriod);
            periods.push({
                ...
                prices: [
                    0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.23, 0.23, 0.23, 0.23, 0.23, 0.23, 0.23, 0.23, 0.23, 0.23,
                    0.23, 0.59, 0.59, 0.59, 0.59, 0.23, 0.23, 0.23,
                ],
            } as EnergyPeriod);
