...
ARG WATCHDOG_DISABLED_DEVICES
ARG WATCHDOG_INTERVAL_DEVICES
ARG WATCHDOG_INTERVAL_SENSORS

ENV PORT=8080
ENV DATABASE_URL="${DATABASE_URL}"
ENV REDIS_URL="${REDIS_URL}"
ENV CLOUDAMQP_URL="${CLOUDAMQP_URL}"
ENV ALLOW_DB_INIT="${ALLOW_DB_INIT}"
...
ENV WATCHDOG_DISABLED_DEVICES="${WATCHDOG_DISABLED_DEVICES}"
